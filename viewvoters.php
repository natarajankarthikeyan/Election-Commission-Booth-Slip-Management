...
<table width="98%" align="center">
	...
	<tr>
		<td colspan="10" align="center"><strong>Voters Details</strong></td>
  </tr>
		   ...
		   <td width="11%"><div align="center" class="style6"><strong>Voter Name</strong> </div></td>
		     <td width="11%"><div align="center" class="style6"><strong>Phone</strong> </div></td>
			  <td width="9%"><div align="center" class="style6"><strong>Address</strong> </div></td>
			   <td width="10%"><div align="center" class="style6"><strong>Ward</strong> </div></td>
			    <td width="10%"><div align="center" class="style6"><strong>Booth</strong> </div></td>
        </tr>
		<tr>
		<td colspan="10">&nbsp;</td>
		</tr>
		<?php
		$qry=mysql_query("select * from voters");
		$i=1;
			   ...
			   <td><div align="center"><?php echo $row['phone'];?></div></td>
				 <td><div align="center"><?php echo $row['address'];?></div></td>
				  <td><div align="center"><?php echo $row['ward'];?></div></td>
				   <td><div align="center"><?php echo $row['booth'];?></div></td>
...
<table width="98%" align="center">
	...
	<tr>
		...
		<?php
		$qry=mysql_query("select * from voters where  booth='$booth'");
		$i=1;
		while($row=mysql_fetch_array($qry))
		{
		?>
